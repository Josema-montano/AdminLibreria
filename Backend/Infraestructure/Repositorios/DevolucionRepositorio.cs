...
namespace Infraestructure.Repositorios
{
 ...
 public async Task<Devolucion?> ObtenerPorIdAsync(int id) => await _context.Devoluciones.Include(d=>d.Producto).Include(d=>d.Cliente).FirstOrDefaultAsync(x=>x.Id==id);
