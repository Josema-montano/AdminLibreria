...
namespace Aplication.UseCases.POS
{
 ...
 public async Task EjecutarAsync(int ventaId, string motivo, string? motivoDevolucion, int? clienteId = null)
 {
 ...
 bool esDevolucion = motivo.Trim().ToLower() == "devolucion";
 if (esDevolucion && string.IsNullOrWhiteSpace(motivoDevolucion))
 throw new ArgumentException("Debe indicar el motivo de devolución");
