...
namespace Aplication.UseCases.Productos
{
 ...
 if(string.IsNullOrWhiteSpace(producto.Codigo)) throw new ArgumentException("Código requerido");
 ...
 if(existe!=null) throw new InvalidOperationException("Código ya existe");
